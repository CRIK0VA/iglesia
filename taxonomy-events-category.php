			...
			<div class="taxlist wrapper">
				<ul>
					...
					foreach($wcatTerms as $wcatTerm) : ?>
						...
						<li <?php if($current_term == $wcatTerm->name) { echo 'class="active"'; }  ?>><a href="<?php echo get_term_link( $wcatTerm->slug, $wcatTerm->taxonomy );?>" class="event_category_link"><?php echo $wcatTerm->name;?></a></li>
